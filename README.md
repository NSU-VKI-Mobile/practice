...
Необходимо разработать Android-приложение для расчёта прибыльности вклада.
Приложение должно реализовывать двухэтапный ввод данных (каждый этап — отдельный экран)
и использовать архитектурный подход MVVM с сохранением данных через Room Database.
