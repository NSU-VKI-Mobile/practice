# practice 2
Нужно сделать экран, использовать фрагементы или compose. У вас есть структура данных которая хранит цвета по названиям, пользователь вводит название цвета, по нажатию кнопки происходит поиск цвета в вашей структуре для хранения доступных цветов.
