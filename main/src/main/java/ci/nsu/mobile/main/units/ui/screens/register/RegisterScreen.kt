...
fun RegisterScreen(
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(viewModel.birthDate, {viewModel.birthDate = it}, label = {Text("День рождения")})
        OutlinedTextField(viewModel.gender, {viewModel.gender = it}, label = {Text("Пол")})
