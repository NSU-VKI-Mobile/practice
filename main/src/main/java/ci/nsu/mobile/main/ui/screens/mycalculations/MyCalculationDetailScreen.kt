...
fun MyCalculationDetailScreen(
    ...
    Column(
        ...
        // Карточка с данными (занимает оставшееся пространство)
        Card(
            modifier = Modifier
                .fillMaxWidth()
                .weight(1f)
            ...
            Column(
                ...
                Text(text = "Итоговая сумма: ${String.format("%.2f", calculation.finalAmount)} руб.", fontSize = 20.sp, modifier = Modifier.padding(vertical = 4.dp))
